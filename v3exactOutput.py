...
stg = w3.eth.contract(address=STG_ADDRESS, abi=ERC20_ABI)
...
# driver 
def main():
  approve = wmatic.functions.approve(ROUTER_ADDRESS, AMOUNT_IN_WITH_SLIPPAGE).build_transaction(tx)
  print ('[-] Approving... ')
  ...
  swap = router.functions.exactOutput(params).build_transaction(tx)
